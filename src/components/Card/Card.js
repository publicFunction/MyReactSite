...
class Card extends Component {
  ...
  chooseCardType = () => {
    switch (this.props.classes) {
      case 'Twitter':
        return (
          <Twitter classes={this.props.classes} />
        );
      case 'Twitch':
        return (
          <Twitch classes={this.props.classes} />
        );
      case 'Star-Citizen':
        return (
          <StarCitizen classes={this.props.classes} />
        );
      case 'Squadron-42':
        return (
          <Squadron42 classes={this.props.classes} />
        );
      case 'Live':
        return (
          <Live classes={this.props.classes} />
        );
      case 'Star-Citizen-Org':
        return (
          <StarCitizenOrg classes={this.props.classes} />
        );
      default:
        return (
